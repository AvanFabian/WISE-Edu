      ...
      <div className="flex border-b-[1px] border-[#aaa8a8] pb-3 lg:pb-6">
        <div className="flex flex-col basis-4/6 gap-3">
          <div className="flex flex-col w-full">
            <h2 className="text-[#414040] text-base lg:text-xl font-bold">
              Avan Fabian Daniswara
            </h2>
            <h4 className="text-[#5c5c5c] opacity-80 text-[14px] lg:text-xs font-bold">
              AvanFabian
            </h4>
          </div>
          <div className="flex flex-col w-full gap-1">
            <h5 className="text-[#020202] opacity-80 text-[14px] lg:text-xs font-normal">
          ...
          <div className="relative w-full px-3 py-3 flex border-2 bg-[#ebe2cd] border-[#c4bfbf62] rounded-2xl justify-end">
            ...
            <div className="items-center flex w-3/4">
              <div className="flex flex-col w-max">
                <h2 className="text-[#414040] my-auto text-[14px] lg:text-xs font-bold">
                  Tantangan Selesai
                </h2>
                <h2 className="text-[#414040] my-auto text-[16px] lg:text-xs font-semibold">
                  [5]
                </h2>
              </div>
            </div>
      ...
      <div className="flex flex-col pt-6">
        <div className="flex flex-row">
          <div className="flex w-full">
            <h2 className="text-[#414040] text-sm lg:text-base font-bold">Pencapaian</h2>
          </div>
          <div className="flex w-full justify-end">
            <h2 className="text-[#BE8756] text-sm lg:text-base font-bold">Lihat Semua</h2>
          </div>
        </div>
      </div>
    </div>
