...
const ProfileAkun = () => {
  ...
  if (status === "unauthenticated") {
    return <div>Please log in to view your profile.</div>; // Show a message for unauthenticated users
  }
      ...
      <div className="flex flex-col pt-6">
        <div className="flex flex-row">
          <div className="flex w-full">
            <h2 className="text-[#050404] text-base md:text-xl font-bold">Pencapaian</h2>
          </div>
          <div className="flex w-full justify-end">
            <h2 className="text-[#BE8756] text-base md:text-xl font-bold">Lihat Semua</h2>
          </div>
        </div>
        <div className="flex flex-row gap-5 lg:gap-3 lg:pt-6">
          <div className="relative w-full px-3 py-3 flex border-2 bg-[#ebe2cd] border-[#c4bfbf62] rounded-2xl justify-end">
            {/* className="absolute top-[4px] left-0"  */}
            <Image
              src={fire}
