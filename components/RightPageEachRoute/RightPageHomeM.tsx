  ...
  return (
    <div className="sticky top-0 flex flex-col max-w-[390px]">
      ...
      <div className="flex flex-col w-full mt-8 ml-3">
        <div className="hidden lg:flex lg:flex-col bg-[#ebe2cd] border-[3px] border-[#c4bfbf62] rounded-2xl">
        ...
        <div className=" hidden lg:flex relative flex-col w-full mt-3 lg:mt-4 bg-[#ebe2cd] border-[3px] border-[#c4bfbf62] rounded-2xl">
          <div className="ml-1 mt-1 px-3 py-3">
