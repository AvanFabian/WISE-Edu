      ...
      <div className="w-full bg-[#58CC02] mt-6 py-7 px-4 rounded-2xl">
        <Grid columns="2" gap="5" width="auto">
          ...
          <div className="flex justify-end">
            <div className="flex flex-row w-max gap-4 cursor-pointer items-center px-4 py-7 h-max bg-transparent border-[3px] border-b-[5px] hover:opacity-75 border-[#49494962] rounded-2xl">
                <Image 
                  src={panduan}
                  width={55}
                  height={32}
