      ...
      <div className="w-full bg-gradient-to-l from-[#bc998e] to-[#8B6B61] mt-6 py-6 px-4 rounded-2xl">
        <Grid columns="2" gap="2" width="auto">
          <div className="flex flex-col align-middle my-auto">
            <h1 className="text-[#fffdf1] text-2xl font-bold mb-4 capitalize subpixel-antialiased">Matematika bagian 1</h1>
            <h2 className="text-[#fffdf1] text-xl font-normal subpixel-antialiased">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h2>
          </div>
